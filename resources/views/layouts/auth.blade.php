...
<!-- Mirrored from themesbrand.com/minia/layouts/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 May 2022 20:53:43 GMT -->
<head>

    <meta charset="utf-8" />
    <title>Authentication | CIBC Banking System</title>
                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Minia   . Crafted with <i class="mdi mdi-heart text-danger"></i> by
                                    {{ env('NAME') }}</p>
                            </div>
                        </div>
                    </div>
