    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Deposits Account (2)</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <span class="text-muted mb-3 lh-1 d-block text-truncate">Chequing</span>
                                    <h4 class="mb-3">
                            ...
                            <div class="text-nowrap">
                                <span class="ms-1 text-muted font-size-13">1234567</span>
                            </div>
                        </div><!-- end card body -->
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <span class="text-muted mb-3 lh-1 d-block text-truncate">Savings</span>
                                    <h4 class="mb-3">
                                        $<span class="counter-value" data-target="6258">10</span>
                                    </h4>
                                </div>
                            </div>
                            <div class="text-nowrap">
                                <span class="ms-1 text-muted font-size-13">2345678</span>
                            </div>
                        </div><!-- end card body -->
                    </div><!-- end card -->
                </div><!-- end col-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Credit Account</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-xl-12 col-md-6">
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <span class="text-muted mb-3 lh-1 d-block text-truncate">{{ getenv('APP_NAME') }} VISA</span>
                                    <h4 class="mb-3">
                                        $<span class="counter-value" data-target="865.2">0</span>k
                                    </h4>
                                </div>
                            ...
                            <div class="text-nowrap">
                                <span class="ms-1 text-muted font-size-13">121223344667654</span>
                            </div>
                        </div><!-- end card body -->
                    </div><!-- end card -->
                </div><!-- end col -->
